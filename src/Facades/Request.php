 ...
 * @method static \Illuminate\Support\Collection merge(array<string, mixed> $input)
 * @method static bool hasFile(string $key)
 * @method static string path()
 * @method static string method()
 * @method static bool isMethod(string $method)
 * @method static mixed header(string $key, $default = null)
 * @method static array<string, string[]> headers()
 ...
 * @method static string|array<string, string> userAgent()
